<template>
    ...
    <footer>
        <section class="font-inter bg-gray-100">
            <div class="sm:max-w-xl md:max-w-screen-lg lg:max-w-screen-xl md:px-24 lg:px-8 px-4 pt-16 mx-auto">
                <div class="sm:grid-cols-2 lg:grid-cols-4 grid gap-10 row-gap-6 mb-8">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex">
                            ...
                            <a href="tel:081234567890" aria-label="Telepon kami" title="Telepon Kami"
                                class="text-deep-purple-accent-400 hover:text-deep-purple-800 transition-colors duration-300">08123456789</a>
                        </div>
                        <div class="flex">
                            <p class="mr-1 text-gray-800">Email:</p>
                            <a href="mailto:info@lorem.mail" aria-label="Email Kami" title="Email kami"
                                class="text-deep-purple-accent-400 hover:text-deep-purple-800 transition-colors duration-300">info@lorem.mail</a>
                        </div>
                        <div class="flex">
                    ...
                    <div>
                        ...
                        <div class="flex items-center mt-1 space-x-3">
                            <a href="/"
                                class="hover:text-rose-500 hover:text-deep-purple-accent-400 text-gray-500 transition-colors duration-300">
